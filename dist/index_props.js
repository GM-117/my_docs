...
export default {
    ...
    'updated': "2021-06-30T06:17:52.000Z",
    'excerpt': "Pagic 是基于Deno实现的，所以使用前需要先安装Deno。 1. 安装Deno [不同系统] Shell (Mac, Linux): curl -fsSL https://deno.land/x/install/install.sh | sh PowerShell (Windows): iwr https://deno.land/x/install/install...",
